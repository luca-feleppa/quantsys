...
| `01_download_data.py` · `01_update_data.py` · `01b_download_macro.py` (`--regime-only` = solo regime, skip macro/npz / regime only, skips macro/npz) | dati + macro/regime | shared |
