# VPS HEALTH CHECK (home side) - thin wrapper: reads the private host from
...
# shared secrets parser (common.ps1, refactor step 3, 2026-07-16); it also
...
# remote command: optional repo pull + server-side health check. The pull
