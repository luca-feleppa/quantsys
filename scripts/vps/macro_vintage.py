"""
MACRO SNAPSHOT VINTAGE - prints the last index date of a
...
def main() -> int:
    # UTF-8 boilerplate (Windows cp1252 console: any unicode would crash).
    ...
    # local import: the helper is called even when the rest of the pull does
    ...
    # the vintage is the LAST index date, i.e. the most recent state of the
