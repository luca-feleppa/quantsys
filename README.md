...
| Short-vol arm (backtest storico FHS GJR-GARCH) | 2026-06-25 | 🟡 conferma strutturale | n=2538 scadenze daily 2019→2026: break-even VRP=0% per tutte le strutture; strangle 8-10% tail-safe; edge sopravvive al bid (haircut 16%) e concentrato nell'alta-vol. NON un PASS del gate (resta live n≥20). Script `scripts/vol/short_vol_*`. |
...
| Short-vol arm (FHS GJR-GARCH historical backtest) | 2026-06-25 | 🟡 structural confirmation | n=2538 daily expiries 2019→2026: break-even VRP=0% for all structures; strangle 8-10% tail-safe; edge survives the bid (16% haircut) and concentrates in high-vol. NOT a gate PASS (live n≥20 remains). Scripts `scripts/vol/short_vol_*`. |
