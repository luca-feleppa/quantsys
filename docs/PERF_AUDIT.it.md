🇮🇹 Italiano · [🇬🇧 English](PERF_AUDIT.md)
...
- **Non ho toccato** `tests/test_live_training_parity.py`, i golden sulle 104 feature, i guard
  fail-fast di `THEORY.it.md` §12.5 (il guard σ del backtest è anzi scattato durante l'audit e l'ho
...
| Riallineamento conteggio test | `README.it.md` | — | — |

Suite: **450 passed, 1 skipped** (~45 s). Doc aggiornate: `README.it.md`, `THEORY.it.md` §12.5 (elenco
safety net), `START.it.md` §1.2 (nota Windows + diagnosi rapida dell'exit 139), `CHANGELOG.it.md`,
`STATUS.md`.
