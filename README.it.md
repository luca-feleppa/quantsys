...
- **[Sito di progetto](https://luca-feleppa.github.io/quantsys/index.it.html)** — una pagina per chi non apre il codice: come funziona il motore, il metodo, e ogni esperimento pre-registrato con prior, soglia ed esito, numeri letti dai report dei giudici a ogni build (generatore: `scripts/site/build_site.py`).
